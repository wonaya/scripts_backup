...
outfile = open("merged_all_log10.txt" ,'w')
...
for gene in gene_list :
    ...
    for a in open(sys.argv[1],'r') :
        if a.split("\t")[0] == gene and a.split("\t")[9].strip("\n") != "FPKM" :
            val[1] += math.log10(float(a.split("\t")[9].strip("\n"))+1)
            break
    for a in open(sys.argv[2],'r') :
        if a.split("\t")[0] == gene and a.split("\t")[9].strip("\n") != "FPKM" :
            val[2] += math.log10(float(a.split("\t")[9].strip("\n"))+1)
            break
    for a in open(sys.argv[3],'r') :
        if a.split("\t")[0] == gene and a.split("\t")[9].strip("\n") != "FPKM" :
            val[3] += math.log10(float(a.split("\t")[9].strip("\n"))+1)
            break
    for a in open(sys.argv[4],'r') :
        if a.split("\t")[0] == gene and a.split("\t")[9].strip("\n") != "FPKM" :
            val[4] += math.log10(float(a.split("\t")[9].strip("\n"))+1)
            break
    for a in open(sys.argv[5],'r') :
        if a.split("\t")[0] == gene and a.split("\t")[9].strip("\n") != "FPKM" :
            val[5] += math.log10(float(a.split("\t")[9].strip("\n"))+1)
            break
    for a in open(sys.argv[6],'r') :
        if a.split("\t")[0] == gene and a.split("\t")[9].strip("\n") != "FPKM" :
            val[6] += math.log10(float(a.split("\t")[9].strip("\n"))+1)
            break
